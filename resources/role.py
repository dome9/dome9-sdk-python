...
@dataclass
class RolePermissions(BaseDataclassRequest):
	"""Permissions
...
@dataclass
class RoleRequest(BaseDataclassRequest):
	"""Role
...
class Role(Dome9Resource):
	...
	def create(self, body: RoleRequest) -> Dict:
		"""Create a new role
	...
	def update(self, role_id: str, body: RoleRequest) -> Dict:
		"""Update a role
